...
// Memeriksa apakah yang mausk bener-benr masyarakat
if ($_SESSION['role'] != 1) {
...
$jumlah_pengduan_selesai = count($pengaduan_selesai);
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fa-solid fas fa-check fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-4 ">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Laporan selesai</div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-success">Laporan dalam Proses</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-warning">Laporan Selesai</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <?php foreach($reports_with_feedback as $p): ?>
                                        <div class="card p-4 mb-3">
                                            ...
                                            <p><?= $p['feedback'] ?? "belum ada tanggapan" ?></p>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                            </div>
