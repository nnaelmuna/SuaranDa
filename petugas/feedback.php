...
// Memeriksa apakah yang mausk bener-benar petugas
if ($_SESSION['role'] != 2) {
    header('Location:../auth/login.php');
    exit;
}

// cek id report benar2 ada
...
// cek form apakah sudah terisi/belum
if($_SERVER['REQUEST_METHOD'] === 'POST') {

    $feedback = $_POST['feedback'] ?? '';
    $petugas_id = $_SESSION['user_id']; //$_SESSION = user yg login
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-warning">Form Tambahkan Feedback untuk laporan dengan ID <?= $report_id ?></h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <button type="submit" class="btn btn-warning">Simpan Feedback</button>
                                    </form>
                                </div>
                            </div>
                        </div>
